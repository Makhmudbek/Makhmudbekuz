...
<head>
    ...
    <title>Makhmudbek </title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="assets/img/favcion.png" rel="icon">
...
<body>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row skills-content">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="progress">
                            <span class="skill">CSS <i class="val">78%</i></span>
                            <div class="progress-bar-wrap">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="assets/img/portfelio-img-1.png" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Website 1</h4>
                                <p>Landing page</p>
                                <div class="portfolio-links">
                                    <a href="assets/img/portfelio-img-1.png" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Web 2"><i class="bx bx-plus"></i></a>

                                    <a href="http://makhmudbek.42web.io/" class="portfolio-details-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="assets/img/portfelio-img-4.png" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Website 4 </h4>
                                <p>Landing page</p>
                                <div class="portfolio-links">
                                    <a href="assets/img/portfelio-img-4.png" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Web 2"><i class="bx bx-plus"></i></a>

                                    <a href="http://makhmudbek1.42web.io/" class="portfolio-details-lightbox"
                                        data-glightbox="type: external" title="Portfolio Details"><i
                                            class="bx bx-link"></i></a>
                                </div>
                            </div>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="copyright">
                &copy; Copyright <strong><span>2021 Created by Makhmudbek Jumaniyazov</span></strong>. All Rights
                Reserved
            </div>
